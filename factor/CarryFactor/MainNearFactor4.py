...
class MainNearFactor4(BaseCarryFactor):
    ...
    def compute_single_factor(self, symbol: str) -> DataFrame:
        ...
        main_near_df['date_delta'] = (main_near_df['far_maturity_date'] - main_near_df['near_maturity_date']).dt.days

        main_near_df['factor'] = np.log(main_near_df['far_close'] / main_near_df['near_close']) * \
                                 (365 / (main_near_df['date_delta']))
